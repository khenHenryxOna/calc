  ...
  const testimonials = [
    { name:'Sophia Reyes', role:'Bride — Wedding 2024', text:"Élume made our wedding day absolutely perfect. The food was exquisite, the presentation was stunning, and their team was so professional. Our guests couldn't stop raving about the lechon!", rating:5, avatar:'https://randomuser.me/api/portraits/women/44.jpg' },
    { name:'Mark Villanueva', role:'Event Manager, LMNI Corp', text:"We've hired Élume for four corporate events now and they never disappoint. On-time, professional, and the food quality is consistently top-tier. Highly recommended for corporate clients.", rating:5, avatar:'https://randomuser.me/api/portraits/men/32.jpg' },
    { name:'Angela Cruz', role:"Birthday Celebrant's Mom", text:"My daughter's debut was a dream come true, in big part thanks to Élume. The dessert table alone was worth every peso. Beautiful setup, delicious food, and the service was seamless.", rating:5, avatar:'https://randomuser.me/api/portraits/women/68.jpg' },
    { name:'Carlo Mendoza', role:'Groom — Wedding 2023', text:"From tasting to the big day, the Élume team was incredible. They accommodated all our requests and dietary needs without any hassle. Best catering experience we've ever had!", rating:5, avatar:'https://randomuser.me/api/portraits/men/55.jpg' },
    { name:'Joanna Lim', role:'Private Party Host', text:"We wanted something intimate yet luxurious for our anniversary dinner. Élume created a bespoke 7-course menu that blew us away. Truly felt like a five-star restaurant at home.", rating:5, avatar:'https://randomuser.me/api/portraits/women/23.jpg' },
    { name:'Richard Santos', role:'HR Director, TechCo PH', text:"Our company Christmas party was the best one yet because of Élume. Everyone was impressed by the food variety and quality. The service crew was friendly and efficient throughout.", rating:5, avatar:'https://randomuser.me/api/portraits/men/78.jpg' },
  ];
